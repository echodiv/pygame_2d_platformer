...
class Enemy(object):
    def __init__(self, x, y, width, height, end):
        ...
        self.walk_right = [
            pygame.image.load("./img/R{}E.png".format(i)) for i in range(1, 12)
        ]
        self.walk_left = [
            pygame.image.load("./img/L{}E.png".format(i)) for i in range(1, 12)
        ]
    ...
    def draw(self, window):
        ...
        if self.visible:
            ...
            if self.vel > 0:
                ...
                self.walk_count += 1
            pygame.draw.rect(
                window, (255, 0, 0), (self.hitbox[0], self.hitbox[1] - 20, 50, 10)
            )
            pygame.draw.rect(
                window,
                (0, 255, 0),
